...
namespace PD_4_Game_
{
    class Program
    {
        ...
        static void createEnemyBullet(Coordinates coordinates)
        {
        ...
        static void moveEnemyBullet(char[,] maze, Coordinates coordinates, LivesNscore data)
        {
        ...
        static void createBullet(Coordinates coordinates)
        {
        ...
        static void moveBullet(char[,] maze, Coordinates coordinates, LivesNscore data)
        {
        ...
        static void moveRight(char[,] maze, Coordinates coordinates, char[,] spelunker)
        {
        ...
        static void moveLeft(char[,] maze, Coordinates coordinates, char[,] spelunker)
        {
        ...
        static void moveUp(char[,] maze, Coordinates coordinates, char[,] spelunker)
        {
        ...
        static void moveDown(char[,] maze, Coordinates coordinates, char[,] spelunker)
        {
        ...
        static void moveGhost(char[,] ghost, Coordinates coordinates)
        {
            eraseGhost(ghost, coordinates);
        ...
        static void printSpelunker(char[,] spelunker, Coordinates coordinates)
        {
            Console.ForegroundColor = ConsoleColor.DarkCyan;
        ...
        static void eraseSpelunker(char[,] spelunker, Coordinates coordinates)
        {
            Console.SetCursorPosition(coordinates.playerY, coordinates.playerX);
        ...
        static void printGhost(char[,] ghost, Coordinates coordinates)
        {
        ...
        static void eraseGhost(char[,] ghost, Coordinates coordinates)
        {
            Console.ForegroundColor = ConsoleColor.DarkRed;
